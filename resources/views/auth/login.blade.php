                ...
                <div
                        ...
                        <div class="flex items-center justify-between mt-3 mb-7">
                            <div class="flex items-center gap-1 select-none">
                                <input type="checkbox"
                                       name="remember"
                                       id="rememberMe">
                                <x-label for="rememberMe"
                                         class="mt-3 font-spline_sans text-sm leading-none text-gray-900 dark:text-dark-text cursor-pointer">Remember
                                    Me</x-label>
                            </div>
                            <x-link href="forgot-password.html">Forgot password?</x-link>
                        </div>
                        <!-- Submit Button -->
                    ...
                    <div class="text-gray-900 dark:text-dark-text font-medium leading-none mt-5">
                        ...
                        <x-link href="{{ route('register') }}"
                                class="text-primary-500 font-semibold">Sign Up</x-link>
                    </div>
                </div>
            </div>
            <!-- End Form Area -->
